...
void BlurShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix,
	ID3D11ShaderResourceView* texture, float _screenWidth, float _screenHeight)
{
	...
	screenSizePtr->screenWidth = _screenWidth;
	screenSizePtr->screenHeight = _screenHeight;
